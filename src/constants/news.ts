...
const newsArticlesData: Omit<NewsArticle, "slug">[] = [
  ...
  },
  {
    ...
    bodyHtml: bodyHtml([
      "Selatox Bio Pharma has expanded GMP manufacturing capacity at its Cikarang facility to meet rising demand from ASEAN partners and export markets that require reliable supply of high-quality aesthetic products. The expansion introduces additional filling capacity, segregated material flows for high-potency handling, and upgraded environmental monitoring tied to centralized alarm management.",
      "Project execution followed validation protocols encompassing installation qualification, operational qualification, and performance qualification for critical equipment, with documentation reviewed by quality assurance and external consultants. Training programs were completed for operators, maintenance staff, and microbiology teams prior to granting release authority for commercial lots.",
      "The investment also adds QC laboratory square footage dedicated to sterility assurance, container-closure integrity testing, and extended characterization of raw materials impacted by global supply variability. Digital batch records now integrate weigh-step verification and electronic signatures aligned with data integrity guidance.",
      "Operations leadership expects improved lead times for standard SKUs while maintaining batch release standards that prioritize patient safety over volume targets. Capacity planning models incorporate seasonality, partner forecasts, and safety stock policies designed to absorb transit delays in regional logistics lanes.",
      "Selatox reaffirmed its commitment to workplace safety, halal-compliant handling where applicable, and environmental stewardship across the campus. Community engagement sessions will continue with local stakeholders as production ramps, providing transparency on employment, training, and infrastructure impacts.",
    ]),
  },
  {
    id: 5,
  ...
  },
  {
    ...
    date: "Oct 05, 2025",
    publishedYear: 2025,
    title: "Quality Management System Recertification Completed.",
    imageSrc: IMAGES[7].src,
    imageAlt: IMAGES[7].alt,
    bodyHtml: bodyHtml([
      "Selatox Bio Pharma has completed annual surveillance review of its quality management system, with auditors reaffirming GMP compliance across core manufacturing, packaging, laboratory, and warehouse operations. The review evaluated documentation control, change management, deviation investigations, CAPA effectiveness, and management review minutes demonstrating closed-loop accountability.",
      "Supplier qualification files, raw material variability programs, and batch record review practices were sampled across multiple product families to confirm consistent application of standards. Training records were assessed for role-based curricula covering aseptic behaviour, data integrity, and emergency response.",
      "No critical observations were recorded. Minor findings related to formatting consistency in secondary records were addressed during the audit window with verified corrections. Prior-cycle corrective actions remained effectively implemented according to follow-up evidence presented by site leadership.",
      "Quality assurance communicated outcomes to operations, engineering, and commercial teams with emphasis on sustaining gains rather than treating certification as a periodic event. Internal audit schedules for the next fiscal year will prioritize IT systems validation and cold-chain monitoring redundancies.",
      "Partners seeking summary certificates may request documentation through their account teams. Selatox reminds distributors that only products accompanied by current release paperwork and intact tamper-evident features should be placed into clinic inventory.",
    ]),
  },
  {
    id: 9,
  ...
  },
  {
    ...
    date: "Sep 08, 2024",
    publishedYear: 2024,
    title: "Selatox Publishes Carbon Reduction Targets for Cikarang Campus.",
    imageSrc: IMAGES[3].src,
    imageAlt: IMAGES[3].alt,
    bodyHtml: bodyHtml([
      "Selatox Bio Pharma published carbon reduction targets for its Cikarang campus, outlining investments in energy-efficient utilities, waste heat recovery, and renewable electricity procurement where grid options permit credible tracking. The plan includes baseline measurements verified by third-party consultants and annual public reporting on progress indicators.",
      "Engineering projects prioritize chilled water system optimisation, LED retrofits, and consolidation of air handling units serving classified areas without compromising environmental monitoring limits. Packaging teams evaluate material reductions that maintain product protection during tropical transit.",
      "Leadership linked sustainability goals to operational discipline, noting that efficient manufacturing often correlates with lower scrap, shorter cycle times, and improved right-first-time release rates. Employees will receive training on energy-conscious behaviours in laboratories and warehouses.",
      "Partners asked about environmental claims should reference only approved corporate sustainability summaries distributed through official channels. Selatox avoids unsupported green marketing statements on product labeling unless explicitly cleared by regulatory teams.",
      "The company invited stakeholders to provide feedback on the plan during an upcoming virtual town hall, registration details to follow on the newsroom calendar.",
    ]),
  },
  {
    id: 20,
    ...
    imageAlt: IMAGES[7].alt,
    bodyHtml: bodyHtml([
      "Selatox Bio Pharma hereby gives notice that the Annual General Meeting of Shareholders for fiscal year 2024 will be held on August 22, 2024, at 10:00 WIB at the company's headquarters in Jakarta, with virtual participation available for qualified shareholders who register in advance. The agenda includes approval of audited financial statements, election of board members as proposed, appointment of external auditors, and authorization for directors to execute strategic transactions within defined thresholds.",
      "Proxy materials and annual reports will be distributed in accordance with statutory timelines, providing summaries of operations, risk factors, related-party transactions, and sustainability initiatives. Shareholders may submit questions in writing seven days before the meeting for inclusion in management responses where appropriate.",
      "Voting procedures comply with corporate bylaws and prevailing securities regulations. Independent scrutineers will oversee ballot collection for in-person and electronic votes. Results will be published on the newsroom within two business days of the meeting.",
      "Media attendance is limited to a designated press section without voting rights. Photographers must refrain from capturing documents displayed on presentation screens containing unpublished financial detail.",
      "For registration assistance, shareholders should contact the investor relations desk during business hours. This notice is authoritative; informal summaries circulating on messaging platforms may be incomplete or outdated.",
    ]),
  },
];
