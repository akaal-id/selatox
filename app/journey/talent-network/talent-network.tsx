...
export function TalentNetwork({ content }: TalentNetworkProps) {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      await submitTalentNetwork(form);
      setSubmitted(true);
    } catch {
      setSubmitError(talentNetwork.submitErrorMessage);
    } finally {
            ...
            <form className={styles.form} onSubmit={handleSubmit} noValidate>
              ...
              <div className={styles.field}>
                <SelectForm
                  ...
                  onChange={(value) =>
                    updateField("areaOfInterest", value as TalentNetworkArea)
                  }
                  options={talentNetworkAreas.map((area) => ({
                    label: area,
                    value: area,
                  }))}
                ...
                {errors.areaOfInterest ? (
                  <p className={styles.error}>{errors.areaOfInterest}</p>
                ) : null}
              </div>
              ...
              <div className={styles.fieldRow}>
                ...
                <div className={styles.field}>
                  ...
                  />
                  <p className={styles.hint}>{talentNetwork.resumeHint}</p>
                  {errors.resume ? (
